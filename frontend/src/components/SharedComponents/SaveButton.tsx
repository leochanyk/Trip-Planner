...
export default function SaveButton({ activityId }: { activityId: number }) {
  ...
  const dispatchUnBookmarkActivityEvent = useEvent<UnBookmarkActivityEvent>(
  ...
  async function saveButtonIsPressed() {
    let result = await fetchNonGetData("/insertActivity", "POST", {
  ...
  async function checkIsSaved() {
    let result = await fetchNonGetData("/checkIsSaved", "POST", {
      data: activityId,
    });
  ...
  async function deleteSavedActivity() {
    let result = await fetchNonGetData("/deleteSavedActivity", "DELETE", {
      data: activityId,
    });
    ...
    <>
      ...
      <Modal
        ...
        title={
          <Text>
            {" "}
            <IconHeart /> Select Date and Time
          </Text>
        }
      >
        <DatePicker
