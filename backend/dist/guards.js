        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!token) {
                        return [2 /*return*/, res.status(401).json({ message: "Missing Token" })];
                    }
                    payload = jwt_simple_1.default.decode(token, env_1.env.JWT_SECRET);
                    console.log("payload", payload);
                    return [4 /*yield*/, user_routes_1.userService.getUserById(payload.id)];
                case 1:
                    user = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/, res.status(404).json({ msg: "Invalid JWT error" })];
            }
        });
    });
}
