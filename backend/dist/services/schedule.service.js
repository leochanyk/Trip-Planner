...
var ScheduleService = /** @class */ (function () {
    function ScheduleService(knex) {
        this.knex = knex;
    }
    ScheduleService.prototype.getSchedule = function (schedule_id) {
        return __awaiter(this, void 0, void 0, function () {
            var data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.knex
                            .select("activity.name as name", "start_time", "end_time", "day", "content.id as id")
                            .from("content")
    ...
    ScheduleService.prototype.updateSchedule = function (day, startTime, endTime, contentID) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.knex("content")
                                .update({
                                day: day,
